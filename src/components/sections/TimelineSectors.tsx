...
const BRAND_LOGOS: Record<string, string> = {
  ...
  // dibaga MUST be before hangaw so compound names containing hangaw match dibaga first
...
const BRAND_ROUTES: Record<string, string> = {
  ...
  'سەروەر': '/khakisarwar',
  'سرور': '/khakisarwar',
  // dibaga MUST be before hangaw so compound routes containing hangaw match dibaga first
  'dibaga': '/manfazdibaga',
  'ديبكة': '/manfazdibaga',
  'دیبگة': '/manfazdibaga',
  'دیبگەی': '/manfazdibaga',
