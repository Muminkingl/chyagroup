                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-6">
                    {t.items.map((cert: any, index: number) => (
                        <a 
                            ...
                            dir="auto"
                            className="flex flex-col h-full bg-white p-6 xl:px-4 xl:py-6 rounded-3xl overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-[#0c1a2e]/5 transition-all duration-300 hover:-translate-y-1 cursor-pointer"
                        >
                            {/* Logo Area */}
                            ...
                            {/* Text Content */}
                            <h3 className="text-sm font-bold text-[#0c1a2e] mb-2 leading-snug whitespace-nowrap tracking-tight">
                                {cert.title}
                            </h3>
